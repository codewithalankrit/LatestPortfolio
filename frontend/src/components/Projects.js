        ...
        <div className="relative overflow-hidden">
          {project.videoUrl && !videoError ? (
            <div className="relative">
              ...
              />
              <div className="absolute top-4 right-4 bg-purple-600/90 text-white text-xs font-semibold px-2.5 py-1 rounded-full flex items-center shadow-lg border border-purple-400/30">
                <span className="w-2 h-2 rounded-full bg-pink-400 animate-ping mr-1.5"></span>
                ⚡ AI Video
              </div>
            </div>
          ) : (
          ...
          {project.featured && (
            <div className="absolute top-4 left-4 bg-gradient-to-r from-cyan-400 to-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium shadow-md">
              Featured
            </div>
          )}
        </div>
